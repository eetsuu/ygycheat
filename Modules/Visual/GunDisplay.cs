    ...
    internal class GunDisplay
    {
        ...
        public static void Draw(Entity e)
        {
            ...
            if (!string.IsNullOrEmpty(Icon))
                GameState.renderer.drawList.AddText(Renderer.GunIconsFont, 15, new Vector2(rect.Value.TopRight.X, rect.Value.TopRight.Y - 10f), ImGui.ColorConvertFloat4ToU32(TextColor), Icon);
