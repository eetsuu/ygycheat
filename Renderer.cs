...
namespace Titled_Gui
{
    public class Renderer : Overlay
    {
        ...
        public void RenderWaterMark()
        {
            ...
            {
                ImGui.SetNextWindowSize(new(150, 80));
                ImGui.SetNextWindowPos(new(screenSize.X / 55, 0));
                ...
                Stlye.WindowRounding = 17f;
                var DrawList = ImGui.GetWindowDrawList();
                Vector2 TextPosition = ImGui.GetWindowPos() + new Vector2(20, 20);
                DrawList.AddText(ImGui.GetWindowPos() + new Vector2(20, 20), ImGui.ColorConvertFloat4ToU32(accentColor), "Ygy");
                ...
                ImGui.BeginChild("MainContent", mainSize, ImGuiChildFlags.None, ImGuiWindowFlags.NoBackground);
                {
                    ...
                    switch (selectedTab)
                    {
                        ...
                        case 4: // settings
                            ...
                            ImGui.Text("tietoa:");
                            ImGui.Text($"ygy V{Configs.Version}");
                            ImGui.Text("ygy made with love <3 by EETSU");
